...
export default function Login() {
  ...
  return (
    <Box 
      sx={{ 
        minHeight: '100vh', 
        background: 'linear-gradient(135deg,rgb(26, 27, 30) 0%, #764ba2 100%)',
        display: 'flex',
        alignItems: 'center',
          ...
          <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, minHeight: '600px' }}>
            ...
            >
              ...
              <Box sx={{ position: 'absolute', top: 20, right: 20, display: 'flex', alignItems: 'center', gap: 1 }}>
                ...
                <Typography variant="body2" sx={{ color: '#000' }}>עברית</Typography>
              </Box>
            ...
            <Box sx={{ p: { xs: 4, md: 6 }, flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
              ...
              <Box sx={{ textAlign: 'center', mt: 3 }}>
                <Typography variant="body2" color="text.secondary">
                  ...
                  <Link component={RouterLink} to="/register" sx={{ color: '#6c63ff', fontWeight: 600, textDecoration: 'none' }}>
                    Register
                  </Link>
                </Typography>
              </Box>
